...
public class Learnframe {
	...
	public static void main(String[] args) throws IOException{
        ...
        //nested frame
        //driver.switchTo().frame(2);//nested  frame 1 st one(based on index)
        //webElement
        WebElement webframe = driver.findElement(By.xpath("//iframe[@src='default.xhtml']"));
        driver.switchTo().frame(webframe);//nested  frame 1 st one(based on webelement)
        driver.switchTo().frame("frame2");//second one//String id/name
